...
const suggestionPoolByLanguage: Record<AppLanguage, string[]> = {
  ...
  de: [
    "Entwerfe einen Projektplan für die Einführung einer neuen KI-Funktion.",
    "Erstelle eine wöchentliche Zusammenfassung von Aktionen mit Prioritäten.",
    "Hilf mir, eine Wissensdatenbank für mein Team zu strukturieren.",
    "Schlage 5 Content-Ideen vor, um mein Produkt zu präsentieren.",
    "Bereite eine E-Mail vor, um eine Produktentwicklung anzukündigen.",
    "Erstelle eine Onboarding-Checkliste für einen neuen Mitarbeiter.",
    "Wandle diese Notizen in einen 30-Tage-Ausführungsplan um.",
    "Führe ein kurzes UX-Audit meiner Landingpage durch.",
    "Erstelle ein Skript für ein wöchentliches Meeting mit Aktionspunkten.",
    "Schlage einfache KPIs zur Verfolgung meines Projekts vor.",
    "Fasse diesen Text in einer Executive- und einer operativen Version zusammen.",
    "Hilf mir, eine klare Produkt-FAQ zu schreiben.",
    "Erstelle eine priorisierte To-Do-Liste aus meinem Hauptziel.",
    "Gib mir 10 Ideen für LinkedIn-Beiträge für mein Unternehmen.",
    "Bereite einen Testplan vor, um eine neue Funktion zu validieren.",
    "Schreibe ein kreatives Briefing für eine Marketingkampagne.",
    "Erstelle eine Projektrisikotabelle mit Gegenmaßnahmen.",
    "Schreibe eine umsetzbare Vorlage für Besprechungsnotizen.",
    "Schlage einen No-Code-Workflow vor, um wiederkehrende Aufgaben zu automatisieren.",
    "Hilf mir, das Wertversprechen meines Produkts zu klären.",
    "Übersetze diese Nachricht mit einem professionellen Ton ins Deutsche.",
    "Bereite eine 45-minütige tägliche Lernroutine vor.",
    "Erstelle einen 7-Tage-Anti-Prokrastinations-Plan mit messbaren Zielen.",
    "Gib mir 8 Anzeigenaufhänger für A/B-Tests.",
  ],
  it: [
    "Redigi un piano di progetto per lanciare una nuova funzione IA.",
    "Crea un riepilogo settimanale delle azioni con priorità.",
    "Aiutami a strutturare una knowledge base per il mio team.",
    "Proponi 5 idee di contenuto per presentare il mio prodotto.",
    "Prepara un'email per annunciare un'evoluzione del prodotto.",
    "Crea una checklist di onboarding per un nuovo collaboratore.",
    "Trasforma questi appunti in un piano di esecuzione di 30 giorni.",
    "Fai un rapido audit UX della mia landing page.",
    "Genera uno script per una riunione settimanale con azioni concrete.",
    "Proponi KPI semplici per seguire il mio progetto.",
    "Riassumi questo testo in versione esecutiva e operativa.",
    "Aiutami a scrivere una FAQ di prodotto chiara.",
    "Crea una lista di cose da fare prioritizzata dal mio obiettivo principale.",
    "Dammi 10 idee per post su LinkedIn per la mia attività.",
    "Prepara un piano di test per convalidare una nuova funzionalità.",
    "Scrivi un brief creativo per una campagna di marketing.",
    "Crea una tabella dei rischi del progetto con mitigazioni.",
    "Scrivi un modello di verbale di riunione attuabile.",
    "Proponi un flusso di lavoro no-code per automatizzare compiti ripetitivi.",
    "Aiutami a chiarire la proposta di valore del mio prodotto.",
    "Traduci questo messaggio in tedesco con tono professionale.",
    "Prepara una routine di studio quotidiana di 45 minuti.",
    "Crea un piano anti-procrastinazione di 7 giorni con obiettivi misurabili.",
    "Dammi 8 ganci pubblicitari per test A/B.",
  ],
};
