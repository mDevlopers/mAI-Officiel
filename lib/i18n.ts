...
export const dictionary = {
  ...
  de: {
    ...
    "errors.badRequestApi": "Die Anfrage konnte nicht verarbeitet werden. Bitte überprüfen Sie Ihre Eingabe und versuchen Sie es erneut.",
    "errors.gateway": "AI Gateway benötigt eine gültige Kreditkarte, um Anfragen zu bearbeiten.",
    ...
    "errors.rateLimit": "Sie haben das Nachrichtenlimit erreicht. Kommen Sie in 1 Stunde wieder, um weiter zu chatten.",
    "errors.chatNotFound": "Der angeforderte Chat wurde nicht gefunden. Bitte überprüfen Sie die Chat-ID und versuchen Sie es erneut.",
    "errors.chatForbidden": "Dieser Chat gehört einem anderen Benutzer. Bitte überprüfen Sie die Chat-ID und versuchen Sie es erneut.",
    "errors.chatUnauthorized": "Sie müssen sich anmelden, um diesen Chat zu sehen. Bitte melden Sie sich an und versuchen Sie es erneut.",
    "errors.offline": "Wir haben Probleme beim Senden Ihrer Nachricht. Bitte überprüfen Sie Ihre Internetverbindung und versuchen Sie es erneut.",
    "errors.documentNotFound": "Das angeforderte Dokument wurde nicht gefunden. Bitte überprüfen Sie die Dokument-ID und versuchen Sie es erneut.",
    "errors.documentForbidden": "Dieses Dokument gehört einem anderen Benutzer. Bitte überprüfen Sie die Dokument-ID und versuchen Sie es erneut.",
    "errors.documentUnauthorized": "Sie müssen sich anmelden, um dieses Dokument zu sehen. Bitte melden Sie sich an und versuchen Sie es erneut.",
    "errors.documentBadRequest": "Die Anfrage zum Erstellen oder Aktualisieren des Dokuments war ungültig. Bitte überprüfen Sie Ihre Eingabe und versuchen Sie es erneut.",
    "errors.default": "Etwas ist schief gelaufen. Bitte versuchen Sie es später noch einmal.",
  },
  it: {
    ...
    voiceMode: "mAI Voice",
    voiceModeLabel: "Modalità solo voce (Sperimentale)",
    ...
    "errors.database": "Si è verificato un errore durante l'esecuzione di una query sul database.",
    "errors.badRequestApi": "Impossibile elaborare la richiesta. Controlla il tuo input e riprova.",
    "errors.gateway": "AI Gateway richiede una carta di credito valida per elaborare le richieste.",
    "errors.authRequired": "Devi accedere prima di continuare.",
    "errors.authForbidden": "Il tuo account non ha accesso a questa funzione.",
    "errors.rateLimit": "Hai raggiunto il limite di messaggi. Torna tra 1 ora per continuare a chattare.",
    "errors.chatNotFound": "La chat richiesta non è stata trovata. Controlla l'ID della chat e riprova.",
    "errors.chatForbidden": "Questa chat appartiene a un altro utente. Controlla l'ID della chat e riprova.",
    "errors.chatUnauthorized": "Devi accedere per visualizzare questa chat. Accedi e riprova.",
    "errors.offline": "Stiamo riscontrando problemi nell'invio del tuo messaggio. Controlla la tua connessione Internet e riprova.",
    "errors.documentNotFound": "Il documento richiesto non è stato trovato. Controlla l'ID del documento e riprova.",
    "errors.documentForbidden": "Questo documento appartiene a un altro utente. Controlla l'ID del documento e riprova.",
    "errors.documentUnauthorized": "Devi accedere per visualizzare questo documento. Accedi e riprova.",
    "errors.documentBadRequest": "La richiesta di creazione o aggiornamento del documento non era valida. Controlla il tuo input e riprova.",
