    ...
    <div className="liquid-glass flex h-full w-full flex-col gap-6 overflow-y-auto p-6 md:p-10">
      ...
      <section className="liquid-glass rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/10 via-background/60 to-card/70 p-5">
        <h2 className="text-lg font-semibold">
          v0.5.9 · Optimisation IA &amp; maintenance
        </h2>
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground">
          <li>
            <strong>Optimisation IA :</strong> travail sur les requêtes API
            Google AI avec correction de bugs sur la gestion des modèles Gemini.
          </li>
          <li>
            <strong>Maintenance :</strong> correction de bugs transverses
            signalés pour améliorer la stabilité générale.
          </li>
        </ul>
      </section>
