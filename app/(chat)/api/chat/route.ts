...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Préfère la géolocalisation client si fournie et validée par le schéma.
    if (requestBody.clientGeolocation) {
      longitude = String(requestBody.clientGeolocation.longitude);
      latitude = String(requestBody.clientGeolocation.latitude);
    }
